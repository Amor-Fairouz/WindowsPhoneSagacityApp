...
namespace SagacityWP.Views
{
    ...
    /// </summary>
    public sealed partial class AccLoved : Page
    {
        ...
        public AccLoved()
        {
           ...
           // sendToast(10, "The harder you work, the harder it is to surrender", "Sagacity");
        ...
        {
            Frame.Navigate(typeof(AuthorPage));
        }
        ...
        private void Image_Tapped(object sender, TappedRoutedEventArgs e)
        {
            ...
            SendToast(strStrings[i], "Quote of The Day");
